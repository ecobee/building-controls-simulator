...
# install_ep "8-6-0" "198c6a3cff" "${_ENERGYPLUS_INSTALL_DIR}"
# install_ep "8-7-0" "78a111df4a" "${_ENERGYPLUS_INSTALL_DIR}"
# install_ep "8-8-0" "7c3bbe4830" "${_ENERGYPLUS_INSTALL_DIR}"
